...
for N in [2,4]:
    for e in [1,5,10]:
        ...
        for l in [1,2,3]:
            ...
            axs[0,l-1].grid()
            axs[1,l-1].plot(xcouplings,eval('y_errors_l{}_{}d_e{}_k0'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='>',color ='#ff6600' ,label = 'Ground State')
            axs[1,l-1].plot(xcouplings,eval('y_errors_l{}_{}d_e{}_k1'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='^',color ='#088A08' ,label = '1st Excited')
            axs[1,l-1].plot(xcouplings,eval('y_errors_l{}_{}d_e{}_k2'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='*',color ='#b30000' ,label = '2nd Excited')
            axs[1,l-1].plot(xcouplings,eval('y_errors_l{}_{}d_e{}_k3'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='o',color ='#2E9AFE' ,label = '3rd Excited')
            ...
            axs[1,l-1].grid()
            axs[2,l-1].plot(xcouplings,eval('y_momenta_l{}_{}d_e{}_k0'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='>',color ='#ff6600' )
            axs[2,l-1].plot(xcouplings,eval('y_momenta_l{}_{}d_e{}_k1'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='^',color ='#088A08' )
            axs[2,l-1].plot(xcouplings,eval('y_momenta_l{}_{}d_e{}_k2'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='*',color ='#b30000' )
            axs[2,l-1].plot(xcouplings,eval('y_momenta_l{}_{}d_e{}_k3'.format(l,N,e)), linestyle='-',linewidth = 3.0, marker='o',color ='#2E9AFE' )
            axs[2,l-1].plot(xcouplings,eval('yP_l{}_{}d_e{}_k0'.format(l,N,e)), linestyle='--',linewidth = 3.0, marker='>',color ='#ff6600' ,label = 'Ground State')
            axs[2,l-1].plot(xcouplings,eval('yP_l{}_{}d_e{}_k1'.format(l,N,e)), linestyle='--',linewidth = 3.0, marker='^',color ='#088A08' ,label = '1st Excited')
            axs[2,l-1].plot(xcouplings,eval('yP_l{}_{}d_e{}_k2'.format(l,N,e)), linestyle='--',linewidth = 3.0, marker='*',color ='#b30000' ,label = '2nd Excited')
            axs[2,l-1].plot(xcouplings,eval('yP_l{}_{}d_e{}_k3'.format(l,N,e)), linestyle='--',linewidth = 3.0, marker='o',color ='#2E9AFE' ,label = '3rd Excited')
            ...
            axs[3,l-1].plot(xcouplings,eval('y_l{}_{}d_e{}_k0-yE_{}d_k0'.format(l,N,e,N))/2, linestyle='-',linewidth = 3.0, marker='>',color ='#ff6600' )
